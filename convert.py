...
# Load NetCDF file
nc_file = "C:/Users/USER/Documents/00/nc-csv-converter/data/1999-2003.nc"  # Replace with actual path
...
for i, t in enumerate(time_chunks):
    ...
    csv_file = f"C:/Users/USER/Documents/00/nc-csv-converter/output/1999-2003/1999_2003_output_chunk_{i}.csv"  # Replace with actual path
