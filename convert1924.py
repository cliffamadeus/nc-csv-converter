...
# Load NetCDF file
nc_file = "C:/Users/USER/Documents/00/nc-csv-converter/data/2019-2024.nc"  # Replace with actual path
...
for i, t in enumerate(time_chunks):
    ...
    csv_file = f"C:/Users/USER/Documents/00/nc-csv-converter/output/2019-2024/2019_2024_output_chunk_{i}.csv"  # Replace with actual path
