...
# Load NetCDF file
nc_file = "C:/Users/USER/Documents/00/nc-csv-converter/data/sample.nc"  # Replace with actual path
...
for i, t in enumerate(time_chunks):
    ...
    csv_file = f"C:/Users/USER/Documents/00/nc-csv-converter/output/year-year/year_year_output_chunk_{i}.csv"  # Replace with actual path
